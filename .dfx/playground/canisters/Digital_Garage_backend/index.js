...
import { idlFactory } from './Digital_Garage_backend.did.js';
export { idlFactory } from './Digital_Garage_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DIGITAL_GARAGE_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Digital_Garage_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Digital_Garage_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Digital_Garage_backend.did.js")._SERVICE>}
 */
export const Digital_Garage_backend = createActor(canisterId);
