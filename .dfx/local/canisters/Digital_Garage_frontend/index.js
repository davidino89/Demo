...
import { idlFactory } from './Digital_Garage_frontend.did.js';
export { idlFactory } from './Digital_Garage_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DIGITAL_GARAGE_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Digital_Garage_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Digital_Garage_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Digital_Garage_frontend.did.js")._SERVICE>}
 */
export const Digital_Garage_frontend = createActor(canisterId);
